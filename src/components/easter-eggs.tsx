  ...
  useEffect(() => {
    ...
    if (typeof console !== "undefined") {
      ...
      console.log(
        ...
        //   "Just press the %c'a'%c key and watch the magic happen! 🪄",
      ...
      ["amey", "Amey", "AMEY"].forEach((name) => {
        ...
        Object.defineProperty(window, name, {
          get() {
            console.log(
              "%c✨ Abra Kadabra! ✨\n\n" +
              "You just summoned the magic of Amey! 🧙‍♂️\n" +
            ...
            const timer = setTimeout(() => {
              console.log(
                "%cPssttt! 🤫\n\n" +
                "Do you like cats?? 😺 If yes, then press 'a' on viewport and see what happens! 🐱✨",
