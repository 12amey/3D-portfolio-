![Portfolio Preview](https://github.com/12amey/3D-portfolio-/blob/main/public/assets/seo/og-image.png?raw=true)
...
### Live preview:https://ameysportfolio.netlify.app/

![Preview]

This project showcases my skills in 3D interactive web design, full-stack development, and AI integration.
...
1. Clone this repository:
   ```bash
   git clone https://github.com/12amey/3D-portfolio-.git
   ```
...
This project is deployed using **Vercel** for its blazing-fast performance and ease of use. You can view the live site [here](https://ameysportfolio.netlify.app/)
...
Special thanks to all the amazing open-source projects and designers who inspire the community! 💡
...
- **LinkedIn:** [Amey Deshmane](https://www.linkedin.com/in/amey-deshmane-85a5672b4/)
